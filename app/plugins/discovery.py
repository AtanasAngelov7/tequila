...
def _load_plugin_class(
    ...
    try:
        ...
        # Clean up partial module entry and all sub-modules to avoid
        # poisoning future imports (TD-388).
        for _key in [k for k in sys.modules if k == module_name or k.startswith(module_name + ".")]:
